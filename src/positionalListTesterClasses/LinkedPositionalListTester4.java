...
import llPositionalList.NewLinkedPositionalList;

public class LinkedPositionalListTester4 {

	public static void main(String[] args) {
		NewLinkedPositionalList<Integer> list1 = new NewLinkedPositionalList<>(new L2FIteratorMaker<Integer>()); 
	...
	private static void removeEvenValues(NewLinkedPositionalList<Integer> list) {
	...
	private static void showList(String msg, NewLinkedPositionalList<Integer> list) {
